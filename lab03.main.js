 ...
 * @return {object} - An Object with two properties ipv4 and ipv6. The values of its properties will be strings.
 */
function getFirstIpAddress(cidrStr, callback) {
  ...
  if (!cidr.isValid()) {
    ...
    if (ipv6Address) {
        ipv4toIpv6Object.ipv4 = cidrStr;
        ipv4toIpv6Object.ipv6 = ipv6Address;
    }
  }
  ...
  return callback(ipv4toIpv6Object, callbackError);
}
